...
### 4.4 What I learned and remaining questions
...
**(At what point does "sharpening the geometry" stop yielding**
**transferable features and start overfitting to the specific contrastive task?)**
...
training task did not anticipate.**(Does this suggest that the "bottleneck"**
**in supervised learning is the label space itself, rather than the model capacity?)**
---
